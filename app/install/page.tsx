...
import { Share2, Apple, Chrome } from 'lucide-react'
                ...
                {isInstallable ? (
                    ...
                    <>
                        <div className="p-6 rounded-lg shadow-md">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
                                    <Image src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Safari_2020_logo.svg/1024px-Safari_2020_logo.svg.png?20240509054828" alt="Safari" width={18} height={18} />
                                </div>
                        ...
                        <div className="p-6 rounded-lg shadow-md">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
                                    <Image src="https://upload.wikimedia.org/wikipedia/commons/e/e1/Google_Chrome_icon_%28February_2022%29.svg" alt="Chrome" width={18} height={18} />
                                </div>
                                <h2 className="text-xl font-semibold">Android Installation</h2>
                            </div>
                            <ol className="list-decimal list-inside space-y-2">
                                <li>Open this website in Chrome</li>
                                <li>Tap the three dots menu <span className="inline-block">⋮</span></li>
